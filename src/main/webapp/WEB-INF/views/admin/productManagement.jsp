        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header" id="logoImg">
                    <a class="navbar-brand" href="index"><img src="images/logo.jpeg" alt="Logo"></a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <button type="button" id="delBtn">체크 제품 삭제</button>
                                <button type="button" onclick="location='addProduct'">상품추가</button>
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <td onclick="location='pDetail?number=${row.p_number}'">${row.p_number}</td>
                                        <td>${row.p_name}</td>
                                        <td>${row.p_price}</td>
                                        <td>${row.p_kind}</td>
                                        <td>${row.p_stock}</td>
