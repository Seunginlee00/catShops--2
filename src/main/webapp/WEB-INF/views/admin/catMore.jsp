                ...
                <div class="">
                    <form>
                        ...
                        <div class="row form-group">
                            <div class="col col-md-2"><label for="file-input" class=" form-control-label">사진 재설정 </label></div>
                            <div class="col-12 col-md-9"><input type="file" id="file-input" name="file-input" class="form-control-file"></div>
                        </div>
                         <!-- 성별(중성화 여부..등등) -->
                         <div class="row form-group">
                            <div class="col col-md-2"><label for="file-input" class=" form-control-label">성별</label></div>
                            <select name="maleNFemale">
                                <option value="male">암</option>
                                <option value="female">수</option>
                         ...
                         <!-- 몸무게 -->
                         <div class="row form-group">
                            <div class="col col-md-2"><label for="file-input" class=" form-control-label">몸무게 </label></div>
                            <div class="col-12 col-md-9"><input type="number" placeholder="몸무게" />kg</div>
                        </div>
