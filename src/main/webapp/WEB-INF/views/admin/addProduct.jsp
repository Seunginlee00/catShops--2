    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            <div class="container-fluid bg-dark">
             <form action="productJoinOk" method="post" enctype="multipart/form-data" class="form-horizontal">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input"
                                        class=" form-control-label">상품명</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="name"
                                        placeholder="상품명 입력" class="form-control"></div>
                            </div>                         
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="company-input"
                             
                                        class=" form-control-label">업체</label><!--</div>
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="price-input"
                                        class=" form-control-label">종류 </label></div>
                                <div class="col-12 col-md-9">
                                    <select name="kind">
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="price-input"
                                        class=" form-control-label">가격</label></div>
                                <div class="col-12 col-md-9">
                                    <input type="number" id="number-input" name="price" placeholder="상품가격 " class="form-control">
                                </div>
                            </div>
                            
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="price-input"
                                        class=" form-control-label">제고 </label></div>
                                <div class="col-12 col-md-9">
                                    <input type="number" id="number-input" name="stock" placeholder="상품제고  " class="form-control">
                                </div>
                            </div>
                            
                            <div class="row form-group">
                                <div class="col col-md-2"><label for="file-input" class=" form-control-label">이미지 추가 </label></div>
                                <div class="col-12 col-md-9"><input type="file" name="image"> 
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input"
                                        class=" form-control-label">상세정보</label></div>
                                <div class="col-12 col-md-9">    
                      		...
                      		<div class="row form-group">
                                <div class="col col-md-3"><label for="text-input"
                                        class=" form-control-label">구독여부 </label></div>
                                <div class="col-12 col-md-9">    
                                    
                                        <p><input type="text" name="subscription"/></p>
