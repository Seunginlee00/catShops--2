            ...
            <div id="section1" class="container-fluid bg-dark">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        ...
                        <form action="aModifyOk" method="post" class="form-horizontal">
                           <c:forEach items="${adtos }" var="row">
                            <div class="row form-group">
                                <div class="col col-md-3"><label class=" form-control-label">이름</label></div>
                                <div class="col-12 col-md-9">
                                    <p class="form-control-static"><strong> ${row.a_name}</strong></p>
                                    <input type="hidden" name="name" value="${row.a_name}">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="email" id="email-input" name="email"
                                        placeholder="Email" class="form-control" value="${row.a_email }"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input"
                                        class=" form-control-label">아이디</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="id"
                                        placeholder="Id" class="form-control" value="${row.a_id }"></div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="password" id="password-input"
                                        name="pw" placeholder="Password" value="${row.a_pw}" class="form-control"></div>
                            </div>
                            </c:forEach>
