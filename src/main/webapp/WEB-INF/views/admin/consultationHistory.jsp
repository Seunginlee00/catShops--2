        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header" id="logoImg">
                    <a class="navbar-brand" href="/admin/index"><img src="${pageContext.request.contextPath }/resources/admin/images/logo.jpeg" alt="Logo"></a>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">상담내역</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <c:forEach items="${list }" var="row">
                                        <tr onclick="location='consultationDetails?o_number=${row.o_number}'">
                                            <td>${row.o_date }</td>
                                            <td>${row.m_name }</td>
                                            <td>${row.o_phone }</td>
                                            <td>${row.o_content }</td>
