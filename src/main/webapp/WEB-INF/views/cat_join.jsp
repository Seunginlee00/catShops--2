			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						<h2>내 고양이 추가</h2>
						<form action="catOk" method="post" enctype="multipart/form-data">
							<div class="row">
								<input type="file" name="image" placeholder="고양이 이미지"/>
								<input type="text" name = "name" placeholder="반려동물 이름"/>
								...
								<input type="text"  name="age" placeholder="반려동물 나이"/>
								
								반려동물 성별  <br/>
								남자 : <input type="radio" name="sex" value="M"/>
								여자  :<input type="radio" name="sex" value="F"/>
								<input type="text" name="weight" placeholder="반려동물 몸무게"/>
								반려동물 중성화 여부 <br/>
								했음 : <input type="radio" name="neutering" value="Y"/>
								하지 않음  : <input type="radio" name="neutering" value="N"/>
