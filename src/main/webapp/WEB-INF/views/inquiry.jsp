    ...
    <section>
		<div class="container">
			<div class="row">
				...
				<form action="swriteOK" method="get">
				<div class="col-sm-9">
                    <div class="card">
                                    ...
                                    <tr>
                                        <th scope="row" class="contents">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9"><textarea name="s_content" id="textarea-input" rows="9" class="form-control"></textarea></div>
                                            </div>
											<div class="row form-group">
												<div class="col col-md-2"><label for="file-input" class=" form-control-label"> 사진첨부 </label></div>
								...
								<tbody>
                                    <tr>
                                        <th scope="row" class="save">
                                            <div id="btn">
                                                <button type="submit" onclick="location='myPage'">취소</button>
