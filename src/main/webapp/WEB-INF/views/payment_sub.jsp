					...
					<div class="login-form">
						...
						<div class="payment">
							<form action="subPaymentOk" method="post">
								...
								<input type="text" name="recipient" placeholder="받는 사람 성함 입력" />
                                <input type="number" name="postcode" placeholder="우편번호 입력" />
								<input type="text" name="destination" placeholder="주소 입력" />
								<select name="month">
                                ...
                                <select name="message" id="selectBox" >
                                    ...
                                    <option value="배송전 연락 바랍니다." selected>배송전 연락 바랍니다.</option>
